...
CLIENTEFFECT_REGISTER_BEGIN(PrecacheEffectPressureCannon)
...
class C_CannonBolt : public C_BaseCombatCharacter
{
	DECLARE_CLASS(C_CannonBolt, C_BaseCombatCharacter);
	DECLARE_CLIENTCLASS();
public:
...
private:
	...
	C_CannonBolt(const C_CannonBolt&); // not defined, not accessible

	Vector	m_vecLastOrigin;
	bool	m_bUpdated;
};

IMPLEMENT_CLIENTCLASS_DT(C_CannonBolt, DT_CannonBolt, CCannonBolt)
END_RECV_TABLE()

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
C_CannonBolt::C_CannonBolt(void)
{
}
...
// Input  : updateType - 
//-----------------------------------------------------------------------------
void C_CannonBolt::OnDataChanged(DataUpdateType_t updateType)
{
...
// Output : int
//-----------------------------------------------------------------------------
int C_CannonBolt::DrawModel(int flags)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_CannonBolt::ClientThink(void)
{
	m_bUpdated = false;
}
...
DECLARE_CLIENT_EFFECT("PressureCannonLoad", CrosshairLoadCallback);
