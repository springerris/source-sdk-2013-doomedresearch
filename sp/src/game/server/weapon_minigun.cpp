...
public:
	...
	float	GetFireRate(void) { 
		...
		if (pOw->IsPlayer()) {
			return MINIGUN_MAX_INTERVAL;
		}
		return MINIGUN_MIN_INTERVAL;
	}	// 13.3hz
	...
	{
		static const Vector cone = VECTOR_CONE_10DEGREES * 3;
		return cone;
	}
...
#ifdef MAPBASE
// Allows Weapon_BackupActivity() to access the Minigun's activity table.
acttable_t* GetMinigun1Acttable()
{
	return CWeaponMinigun::m_acttable;
}

int GetMinigunActtableCount()
{
	return ARRAYSIZE(CWeaponMinigun::m_acttable);
}
#endif
