...
class CWeaponAA12 : public CHLSelectFireMachineGun
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS(CWeaponAA12, CHLSelectFireMachineGun);
	...
	int		GetMinBurst() { return GetMaxClip1()/2; }
	...
	{
		static const Vector cone = VECTOR_CONE_10DEGREES * 30;
		return cone;
	}
...
IMPLEMENT_SERVERCLASS_ST(CWeaponAA12, DT_WeaponAA12)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_aa12, CWeaponAA12);
PRECACHE_WEAPON_REGISTER(weapon_aa12);

BEGIN_DATADESC(CWeaponAA12)
...
acttable_t	CWeaponAA12::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponAA12);

#ifdef MAPBASE
// Allows Weapon_BackupActivity() to access the AA12's activity table.
acttable_t* GetAA12Acttable()
{
	return CWeaponAA12::m_acttable;
}

int GetAA12ActtableCount()
{
	return ARRAYSIZE(CWeaponAA12::m_acttable);
}
#endif

//=========================================================
CWeaponAA12::CWeaponAA12()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAA12::Precache(void)
{
...
//-----------------------------------------------------------------------------
void CWeaponAA12::Equip(CBaseCombatCharacter* pOwner)
{
...
void CWeaponAA12::PrimaryAttack(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAA12::FireNPCPrimaryAttack(CBaseCombatCharacter* pOperator, Vector& vecShootOrigin, Vector& vecShootDir)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAA12::Operator_ForceNPCFire(CBaseCombatCharacter* pOperator, bool bSecondary)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAA12::Operator_HandleAnimEvent(animevent_t* pEvent, CBaseCombatCharacter* pOperator)
{
	switch (pEvent->event)
	{
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CWeaponAA12::GetPrimaryAttackActivity(void)
{
	if (m_nShotsFired < 2)
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAA12::AddViewKick(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAA12::SecondaryAttack(void)
{
	// Only the player fires this way so we can cast
	CBasePlayer* pPlayer = ToBasePlayer(GetOwner());
...
// Output : int
//-----------------------------------------------------------------------------
int CWeaponAA12::WeaponRangeAttack2Condition(float flDot, float flDist)
{
...
//-----------------------------------------------------------------------------
const WeaponProficiencyInfo_t* CWeaponAA12::GetProficiencyValues()
{
